...
/**
 * Resourceful controller for interacting with entidades
 */
class EntidadeController {
  ...
  /**
   * Render a form to be used for creating a new entidade.
  ...
  /**
   * Render a form to update an existing entidade.
   * GET entidades/:id/edit
   *
   * @param {object} ctx
   * @param {Request} ctx.request
   * @param {Response} ctx.response
